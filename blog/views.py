...
from models import Tag, Author, Weibo, Blog
...
def blog_list(request):
    ...
    return render_to_response("blog_list.html", {"blogs": blogs, "tags": tags, "weibos": weibos})
...
def blog_search(request):
    ...
    if 'search' in request.GET:
        ...
        return render_to_response('blog_filter.html', {"blogs": blogs, "tags": tags})
    else:
        blogs = Blog.objects.order_by('-id')
